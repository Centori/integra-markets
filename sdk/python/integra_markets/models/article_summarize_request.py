...
class ArticleSummarizeRequest(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="URL of the article to summarize")
    sentences: Optional[Annotated[int, Field(le=10, strict=True, ge=1)]] = Field(default=5, description="Number of sentences in summary")
    commodity: Optional[StrictStr] = Field(default=None, description="Specific commodity to focus on")
    __properties: ClassVar[List[str]] = ["url", "sentences", "commodity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "url": obj.get("url"),
            "sentences": obj.get("sentences") if obj.get("sentences") is not None else 5,
