...
class SentimentRequest(BaseModel):
    ...
    enhanced: Optional[StrictBool] = Field(default=True, description="Use enhanced analysis")
    __properties: ClassVar[List[str]] = ["text", "commodity", "enhanced"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enhanced": obj.get("enhanced") if obj.get("enhanced") is not None else True
        })
        return _obj
