...
# The sentiment engine lives in services/commodity_sentiment.py and is imported
# here, not defined here. It used to be defined in this file, which meant every
# job, script and test that needed to score a headline imported an unmounted
# FastAPI application to get at it — and read `vader_analyzer`, a global that
# only this file's lifespan() ever set. One implementation, one home.
from services.commodity_sentiment import (  # noqa: E402
    SENTIMENT_BLEND_VADER,
    SENTIMENT_RULE_COEF,
    SENTIMENT_RULE_DOMINANCE_WEIGHT,
    SENTIMENT_THRESHOLD,
    analyze_fundamental_direction,
    analyze_market_sentiment,
    basic_sentiment_analysis,
    build_headline_sentiment_overview,
    determine_market_impact,
    extract_commodity_tickers,
    extract_keywords,
    extract_trigger_keywords_with_relevance,
    get_commodity_rulebook,
    infer_market_targets,
    normalize_commodity,
    signal_weight,
)
